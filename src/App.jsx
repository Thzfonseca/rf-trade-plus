              ...
              <div className="tab-content">
                ...
                {abaAtiva === 'sensibilidade' && (
                  <div className="sensibilidade-content">
                    <div className="sensibilidade-header">
                      <h3>Análise de Sensibilidade Multivariada com Trajetórias Temporais</h3>
                      <p className="sensibilidade-subtitle">
                        Explore como diferentes trajetórias de CDI e IPCA ao longo de 5 anos impactam seus resultados
                      </p>
                    </div>

                    <div className="sensibilidade-controls">
                      <div className="trajetorias-section">
                        <h4>Configuração de Trajetórias</h4>
                        
                        <div className="trajetoria-card">
                          <h5>Trajetória CDI (%)</h5>
                          <div className="trajetoria-inputs">
                            <div className="input-group">
                              <label>Ano 1</label>
                              <input type="number" step="0.1" defaultValue="11.75" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 2</label>
                              <input type="number" step="0.1" defaultValue="13.5" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 3</label>
                              <input type="number" step="0.1" defaultValue="10.0" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 4</label>
                              <input type="number" step="0.1" defaultValue="9.0" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 5+</label>
                              <input type="number" step="0.1" defaultValue="8.5" className="trajetoria-input" />
                            </div>
                          </div>
                        </div>

                        <div className="trajetoria-card">
                          <h5>Trajetória IPCA (%)</h5>
                          <div className="trajetoria-inputs">
                            <div className="input-group">
                              <label>Ano 1</label>
                              <input type="number" step="0.1" defaultValue="4.5" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 2</label>
                              <input type="number" step="0.1" defaultValue="5.5" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 3</label>
                              <input type="number" step="0.1" defaultValue="4.0" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 4</label>
                              <input type="number" step="0.1" defaultValue="3.5" className="trajetoria-input" />
                            </div>
                            <div className="input-group">
                              <label>Ano 5+</label>
                              <input type="number" step="0.1" defaultValue="3.0" className="trajetoria-input" />
                            </div>
                          </div>
                        </div>

                        <div className="sensibilidade-actions">
                          <button className="btn-primary">Calcular Sensibilidade</button>
                          <button className="btn-secondary">Cenários Pré-definidos</button>
                        </div>
                      </div>

                      <div className="resultados-sensibilidade">
                        <h4>Visualização das Trajetórias</h4>
                        
                        <div className="charts-grid">
                          <div className="chart-container">
                            <h5>Trajetórias CDI e IPCA</h5>
                            <div className="chart-placeholder">
                              <ResponsiveContainer width="100%" height={300}>
                                <LineChart data={[
                                  { ano: 'Ano 1', CDI: 11.75, IPCA: 4.5 },
                                  { ano: 'Ano 2', CDI: 13.5, IPCA: 5.5 },
                                  { ano: 'Ano 3', CDI: 10.0, IPCA: 4.0 },
                                  { ano: 'Ano 4', CDI: 9.0, IPCA: 3.5 },
                                  { ano: 'Ano 5', CDI: 8.5, IPCA: 3.0 }
                                ]}>
                                  <CartesianGrid strokeDasharray="3 3" />
                                  <XAxis dataKey="ano" />
                                  <YAxis />
                                  <Tooltip />
                                  <Legend />
                                  <Line type="monotone" dataKey="CDI" stroke="#2563eb" strokeWidth={3} />
                                  <Line type="monotone" dataKey="IPCA" stroke="#dc2626" strokeWidth={3} />
                                </LineChart>
                              </ResponsiveContainer>
                            </div>
                          </div>
                          ...
                          <div className="chart-container">
                            <h5>Impacto nos Resultados</h5>
                            <div className="chart-placeholder">
                              <ResponsiveContainer width="100%" height={300}>
                                <AreaChart data={[
                                  { cenario: 'Pessimista', estrategiaAtual: 2.5, estrategiaProposta: 2.8 },
                                  { cenario: 'Base', estrategiaAtual: 2.67, estrategiaProposta: 2.97 },
                                  { cenario: 'Otimista', estrategiaAtual: 2.85, estrategiaProposta: 3.15 }
                                ]}>
                                  <CartesianGrid strokeDasharray="3 3" />
                                  ...
                                  <Legend />
                                  <Area type="monotone" dataKey="estrategiaAtual" stackId="1" stroke="#64748b" fill="#64748b" fillOpacity={0.6} />
                                  <Area type="monotone" dataKey="estrategiaProposta" stackId="2" stroke="#059669" fill="#059669" fillOpacity={0.6} />
                                </AreaChart>
                              </ResponsiveContainer>
                            </div>
                          </div>
                        ...
                        <div className="insights-sensibilidade">
                          <h4>Insights da Análise</h4>
                          <div className="insights-grid">
                            <div className="insight-card">
                              <h5>Variável Mais Crítica</h5>
                              <p>CDI do Ano 2 tem maior impacto nos resultados (sensibilidade: 15.3%)</p>
                            </div>
                            <div className="insight-card">
                              <h5>Timing Ótimo</h5>
                              <p>Migração para estratégia proposta é robusta em 87% dos cenários</p>
                            </div>
                            <div className="insight-card">
                              <h5>Risco Principal</h5>
                              <p>Convergência tardia do CDI pode reduzir vantagem em 23%</p>
                            </div>
                          </div>
                        </div>
                      </div>
